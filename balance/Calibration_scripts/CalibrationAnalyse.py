...
np.savetxt("Text_files/Calibration/Weight20.txt",Weight,newline='\n')
np.savetxt("Text_files/Calibration/VoltageMean20.txt",VoltageMean,newline='\n')
np.savetxt("Text_files/Calibration/Standard_Deviation20.txt",StandarDeviation,newline='\n')

np.savetxt("Text_files/Calibration/Samples20.txt",Voltage)
